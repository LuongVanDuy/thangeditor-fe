...
import { Login as login } from "@/lib/api/auth.api";
    ...
    <div className="mx-auto flex flex-col gap-8 sm:w-auto 2xs:w-[390px] pb-12 pt-12 md:pt-[64px] px-4">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div
          ...
          className="h-12 border-[1px] border-[#dee2e6] flex justify-center items-center rounded-lg font-medium text-[#495057] cursor-pointer"
        >
          <div>
