        ...
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              stroke={activePage === "/dashboard" ? "#00BC7D" : "#CED4DA"}
              strokeWidth="2"
              strokeLinecap="round"
        ...
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              stroke={activePage === "/dashboard/order" ? "#00BC7D" : "#CED4DA"}
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
        ...
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              stroke={activePage === "/dashboard/services" ? "#00BC7D" : "#CED4DA"}
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
      ...
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            stroke={activePage === "/dashboard/support" ? "#00BC7D" : "#CED4DA"}
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
