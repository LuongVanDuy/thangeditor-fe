    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6 fill-current">
          <path d="M502.3 190.8 327.4 338.1c-23.6 19.6-57.3 19.6-80.9 0L9.7 190.8C3.6 185.8 0 178.2 0 170.1V88c0-26.5 21.5-48 48-48h416c26.5 0 48 21.5 48 48v82.1c0 8.1-3.6 15.7-9.7 20.7zM48 464h416c26.5 0 48-21.5 48-48V206.8L327.4 354.1c-23.6 19.6-57.3 19.6-80.9 0L0 206.8V416c0 26.5 21.5 48 48 48z" />
        </svg>
      ),
      link: "mailto:Trangphotoediting@gmail.com",
      bgColor: "bg-[#EA4335]",
    },
  ];
