  ...
  },
  {
    ...
    children: (
      <div className="text-[#6C757D] text-[16px]">
        <div className="text-[#6C757D] text-[16px]">
          <p className="mb-5">
            Virtual staging is a powerful real estate marketing tool in which a home is staged virtually with the help
            of computer vision technology.
          </p>
          <p>
            It is a digital interior design technique where an editor creates interiors in specific styles by adding or
            editing colors, furniture, accessories, lighting, and other elements in a given space. With virtual
            furniture staging, you can furnish an empty house virtually, without having to buy a single piece of
            furniture. When properties are staged virtually, they help prospective clients visualize the space better
            and perhaps see themselves living there. We have a team of professional editors ready to turn your photos
            into stunning professional images. Our services are offered across the USA, Canada, Australia, the UK,
            Spain, etc.
          </p>
        </div>
      </div>
