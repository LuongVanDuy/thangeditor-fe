      ...
      <div className="sm:px-4 lg:px-[64px] xl:px-[108px] py-12 md:py-[64px] flex flex-col gap-9 md:gap-12">
        <div className="text-center">
          <div className="mb-4">
            ...
            <h2 className="text-[32px] md:text-[40px] lg:text-[48px] font-medium">Day to Twilight</h2>
          </div>

          <div className="mb-9 md:mb-12">
            <h1 className="text-[18px] mb-2">
              Convert a photo from day to twilight to make your listing stand out for just $3
            </h1>
            <h2 className="text-[16px] text-[#495057]">
              Image Edits has a variety of styles and price points to convert daytime images to dusk/night images to
              attract the attention of potential buyers for a property.
            </h2>
          </div>
