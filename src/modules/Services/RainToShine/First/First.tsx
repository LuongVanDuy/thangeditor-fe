    ...
    <div className="sm:px-4 lg:px-[64px] xl:px-[108px] py-12 md:py-[64px] flex flex-col gap-9 md:gap-12 ">
      <div className="flex flex-col gap-6">
        <div>
          ...
          <h1 className="text-[#212529] fonr-medium text-[32px] md:text-[40px] lg:text-[48px]">Rain to Shine</h1>
        </div>

        <p className="text-[#495057] text-[16px]">
          Neither snow, nor rain, nor gloomy day should ruin your listing photos
        </p>
