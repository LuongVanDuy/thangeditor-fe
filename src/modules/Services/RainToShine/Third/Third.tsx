          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-row md:flex-col gap-6 items-center md:items-baseline">
              ...
              <h1 className="text-[#212529] fonr-medium text-[20px] md:text-[32px]">
                With Rain to Shine, we meticulously remove every unwanted sign of bad weather
              </h1>
            </div>

            <p className="text-[#495057] text-[16px]">
              Ideal for <br />
              Photoshoots on bad weather days
              <br />
              Removing rain drops
              <br />
              Making wet driveways and sidewalks look dry
              <br />
              Cleaning up seasonal weather effects
              <br />
              Standardizing photos for consistency
              <br />
              Outdoor venues
              <br />
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 md:gap-12 xl:gap-[96px] px-0 xl:px-8">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-row md:flex-col gap-6 items-center md:items-baseline">
              ...
              <h1 className="text-[#212529] fonr-medium text-[20px] md:text-[32px]">
                Ideal for days when the weather is not nice
              </h1>
            </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex gap-3 items-start">
                ...
                <div className="text-[#495057] text-[16px]">Removal of snow, puddles, ice or other signs of weathe</div>
              </div>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div className="text-[#495057] text-[16px]">Correction of wet or puddled driveways</div>
              </div>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div className="text-[#495057] text-[16px]">Sky replacement</div>
              </div>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div className="text-[#495057] text-[16px]">
                  *Does not include editing of original image, such as Single Exposure or HDR
                </div>
              </div>
            </div>
          </div>
