            ...
            <div className="w-auto xs:w-[386px] border-[1px] border-b-0 border-[#f4f4f4] bg-[#fff] p-6 md:p-8 rounded-t-2xl gap-6 flex flex-col">
              <div className="flex flex-col gap-2">
                ...
                <div className="text-[#6C757D] text-[18px] text-start xs:text-center">
                  <span className="text-[#212529] font-medium text-[36px]">$5 (USD)</span> for 5 images
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6">
                <div className="flex gap-3 items-start">
                  ...
                  <div className="text-[#495057] text-[16px]">1-day (24h) delivery</div>
                </div>
                ...
                <div className="flex gap-3 items-start">
                  ...
                  <div className="text-[#495057] text-[16px]">100% refund if not satisfied</div>
                </div>
                ...
                <div className="flex gap-3 items-start">
                  ...
                  <div className="text-[#495057] text-[16px]">Include source file</div>
                </div>
            ...
            <div className="w-auto xs:w-[386px] border-[1px] border-b-0 border-[#f4f4f4] bg-[#fff] p-6 md:p-8 rounded-t-2xl gap-6 flex flex-col">
              <div className="flex flex-col gap-2">
                <div className="flex flex-col justify-center">
                  ...
                  <h1 className="text-primary uppercase  font-medium text-start xs:text-center">Standard package</h1>
                </div>

                <div className="text-[#6C757D] text-[18px] text-start xs:text-center">
                  <span className="text-[#212529] font-medium text-[36px]">$15 (USD)</span> for 15 images
                </div>
              </div>
