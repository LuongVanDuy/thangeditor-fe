          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-row md:flex-col gap-6 items-center md:items-baseline">
              ...
              <h1 className="text-[#212529] fonr-medium text-[20px] md:text-[32px]">
                Bare spots or dead grass in the lawn is no longer an issue for real estate photos.
              </h1>
            </div>

            <p className="text-[#495057] text-[16px]">
              Grass replacement is not limited to just replacing damaged or discolored grass. It can also be used to
              transform a barren or concrete landscape into a lush green lawn, enhancing the curb appeal of the
              property. Additionally, the service can be extended to remove unwanted objects like weeds, debris, or
              unsightly patches, further enhancing the overall appearance of the lawn.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex gap-3 items-start">
                ...
                <div className="text-[#495057] text-[16px]">
                  Attract potential buyers or renters with beautiful turf photos
                </div>
              </div>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div className="text-[#495057] text-[16px]">
                  {" "}
                  Improves photo quality and visual impact on viewers, making them more attractive and engaging
                </div>
              </div>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div className="text-[#495057] text-[16px]">
                  Increase interaction and real estate transaction opportunities
                </div>
              </div>
            </div>
          </div>
