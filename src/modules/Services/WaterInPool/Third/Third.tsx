    ...
    <>
      <div className="sm:px-4 lg:px-[64px] xl:px-[108px] py-12 md:py-[64px] flex flex-col gap-9 md:gap-12 ">
        <h1 className="text-[24px] xs:text-[30px] lg:text-[36px] font-medium text-center">
          Difference after editing the water in the pool
        </h1>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-row md:flex-col gap-6 items-center md:items-baseline">
              ...
              <h1 className="text-[#212529] fonr-medium text-[20px] md:text-[32px]">
                Make a splash with the Water in Pool service
              </h1>
            </div>

            <p className="text-[#495057] text-[16px]">
              Replacing dirty water with clean water in the pool is important. <br />
              Improvements that add water to an empty pool, remove pool items like vacuum cleaners, hoses and leaves,
              turn water green, hot tubs, fountains and more make your home attractive
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 md:gap-12 xl:gap-[96px] px-0 xl:px-8">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-row md:flex-col gap-6 items-center md:items-baseline">
              ...
              <h1 className="text-[#212529] fonr-medium text-[20px] md:text-[32px]">
                Green swimming pools bring many great benefits
              </h1>
            </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex gap-3 items-start">
                ...
                <div className="text-[#495057] text-[16px]">
                  Attract potential buyers or renters with photos of beautiful blue swimming pools
                </div>
              </div>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div className="text-[#495057] text-[16px]">
                  {" "}
                  Improve photo quality and remove unnecessary objects to make them more attractive
                </div>
              </div>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div className="text-[#495057] text-[16px]">
                  Increase opportunities for interaction and real estate transactions
                </div>
              </div>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div className="text-[#495057] text-[16px]">Increase the value of real estate</div>
              </div>
            </div>
          </div>
        </div>
